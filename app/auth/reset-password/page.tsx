...
function ResetPasswordContent() {
    ...
    const loginHref = role === "organization" ? "/organization/organization_auth" : "/admin/admin_auth";
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-[#070b16] px-6 py-10 text-white lg:px-10">
            <div className="pointer-events-none absolute inset-0">
                <div className="absolute left-[-120px] top-[-120px] h-[340px] w-[340px] rounded-full bg-indigo-500/30 blur-3xl" />
                <div className="absolute right-[-120px] bottom-[-120px] h-[360px] w-[360px] rounded-full bg-cyan-400/20 blur-3xl" />
            </div>
            ...
            <main className="relative mx-auto flex min-h-screen max-w-4xl items-center justify-center">
                <section className="w-full max-w-md rounded-3xl border border-white/15 bg-white/10 p-6 backdrop-blur-xl sm:p-8">
                    <p className="text-xs uppercase tracking-[0.18em] text-cyan-200">Password Recovery</p>
                    ...
                    <form className="mt-6 space-y-4" onSubmit={handleResetPassword}>
                        <div>
                            <label htmlFor="new-password" className="mb-1.5 block text-sm font-medium text-slate-200">
                                New Password
                            </label>
                            <input
                                id="new-password"
                        ...
                        <div>
                            <label htmlFor="confirm-new-password" className="mb-1.5 block text-sm font-medium text-slate-200">
                                Confirm Password
                            </label>
                            <input
                    ...
                    <p className="mt-6 text-center text-sm text-slate-300">
                        Back to login{" "}
                        <Link href={loginHref} className="font-semibold text-cyan-300 hover:text-cyan-200">
                            Sign in
                        </Link>
                    </p>
                </section>
